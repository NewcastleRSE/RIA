...
3. It is also necessary to having working copies of the programs `PLINK <a href="https://zzz.bwh.harvard.edu/plink/index.shtml">`_ and `KING version 2.2.9 <a href="https://www.kingrelatedness.com/history.shtml">`_ **Note:** It is very important to download KING version 2.2.9 and not any later versions as we need to use the `--homog` option which is no longer available in later versions. 
